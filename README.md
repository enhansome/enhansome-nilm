# Awesome NILM (Non-Intrusive Load Monitoring) with stars

![image](https://user-images.githubusercontent.com/28736511/51742581-80aa0c80-20dd-11e9-8ed9-b591a79442a3.png)

A curated list of NILM (also known as Energy Disaggregation or Load Disaggregation) resources. Inspired by [awesome-deep-vision](https://github.com/kjw0612/awesome-deep-vision) ⭐ 11,183 | 🐛 47 | 📅 2023-08-15, [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 78,135 | 🐛 159 | 📅 2026-08-04, [awesome-adversarial-machine-learning](https://github.com/yenchenlin/awesome-adversarial-machine-learning) ⭐ 1,910 | 🐛 5 | 📅 2020-11-26, [awesome-deep-learning-papers](https://github.com/terryum/awesome-deep-learning-papers) ⭐ 26,178 | 🐛 37 | 🌐 TeX | 📅 2024-01-18, [awesome-meta-learning](https://github.com/dragen1860/awesome-meta-learning/) ⭐ 553 | 🐛 2 | 📅 2020-12-21 and [awesome-architecture-search](https://github.com/markdtw/awesome-architecture-search) ⭐ 1,190 | 🐛 2 | 📅 2020-09-15.
...
* **Sequence-to-point learning with neural networks for non-intrusive load monitoring** [\[pdf\]](https://www.aaai.org/ocs/index.php/AAAI/AAAI18/paper/view/16623/15980) [\[code\]](https://github.com/MingjunZhong/seq2point-nilm) ⭐ 117 | 🐛 14 | 🌐 Python | 📅 2020-06-28
...
* SynD: [\[link\]](https://github.com/klemenjak/SynD/) ⭐ 32 | 🐛 0 | 📅 2020-04-07
* SmartSim: [\[link\]](https://github.com/sustainablecomputinglab/smartsim) ⭐ 15 | 🐛 4 | 🌐 Python | 📅 2016-11-09
...
* NILMTK [\[pdf\]](https://arxiv.org/pdf/1404.3878v1.pdf) [\[code\]](https://github.com/nilmtk/nilmtk) ⭐ 945 | 🐛 127 | 🌐 Python | 📅 2026-07-20
  * Recently: NILMTK-Contrib [\[pdf\]](https://nipunbatra.github.io/papers/batra_buildsys_19.pdf) [\[code\]](https://github.com/nilmtk/nilmtk-contrib) ⭐ 142 | 🐛 48 | 🌐 Python | 📅 2026-08-04
...
* awesome-NILM-with-code [\[link\]](https://github.com/zhgqcn/awesome-NILM-with-code) ⭐ 142 | 🐛 0 | 📅 2026-08-10
